    ...
    <>
      ...
      <main className='min-h-screen bg-gradient-to-br from-blue-100 to-teal-100 via-cyan-100'>
        ...
        <div className='w-full h-full pt-12 lg:pt-24 flex flex-row flex-wrap justify-center items-center text-center text-cyan-900'>
          <Link href="/computerscience" className='w-full max-w-md md:w-1/4 md:h-72 flex flex-col p-4 m-2 opacity-80 hover:opacity-100 bg-teal-600 bg-opacity-20 transition-all justify-center text-center items-center hover:shadow-2xl shadow-cyan-900 rounded-xl'>
            <div className=''>
          ...
          <Link href="/python" className='w-full max-w-md md:w-1/4 md:h-72 flex flex-col p-4 m-2 opacity-80 hover:opacity-100 bg-teal-600 bg-opacity-20 transition-all justify-center text-center items-center hover:shadow-2xl shadow-cyan-900 rounded-xl'>
            <div className=''>
          ...
          <Link href="/sql" className='w-full max-w-md md:w-1/4 md:h-72 flex flex-col p-4 m-2 opacity-80 hover:opacity-100 bg-teal-600 bg-opacity-20 transition-all justify-center text-center items-center hover:shadow-2xl shadow-cyan-900 rounded-xl'>
            <div className=''>
