      ...
      <main className='min-h-screen w-full bg-gradient-to-b from-white to-teal-100 via-cyan-100'>
        ...
        <div className='w-full h-full pt-12 lg:pt-24 flex flex-row flex-wrap justify-center items-center text-center text-cyan-900'>
          <div className='max-w-6xl flex flex-row flex-wrap justify-center items-center text-center'>
            ...
            <Link href="/datastructuresandalgorithms" className='w-full md:h-72 flex flex-col p-4 m-2 opacity-80 hover:opacity-100 bg-white bg-opacity-60 transition-all justify-center text-center items-center hover:shadow-2xl shadow-cyan-900 rounded-xl'>
              <div className=''>
                <h2 className='font-bold text-2xl lg:text-4xl p-2 m-2 text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-teal-600'>Data Structures and Algorithms</h2>
                <h3 className='font-bold text-4xl lg:text-xl p-2 m-2 opacity-80'>🧩</h3>
                <p className='text-sm font-bold lg:text-md p-2 m-2 opacity-80'>solving problems with code</p>
              </div>
            </Link>
          </div>
